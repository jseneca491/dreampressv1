...
class ET_Builder_Global_Presets_Settings {
	 ...
	 *
	 * @since 4.10.0
	 * @since ?? Perform substring replacement (for compound settings like background gradient stops).
	 *
	 * @param array $attrs - The module attributes.
	 *
	 * @return array
	 ...
	 *
	 * @since 4.5.0
	 * @since ?? Modified the global color option check to perform a substring match on multipart settings (like gradient stops).
	 *
